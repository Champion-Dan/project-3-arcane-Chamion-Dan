...
import com.arcane.Treasure.Treasure;
import com.arcane.Treasure.TreasureBag;
...
public abstract class Adventurer extends Character {
  ...
  private List<Treasure> inventory = new ArrayList<>();
...
public void levelUp() {
  ...
  protected void searchTreasure() {
    if (baseTreasureRoll + Dice.rollDice() >= 11) {
      treasureCount += 1;
      //expertise.completeTask(); //Delegation to expertise class
    }
  }
